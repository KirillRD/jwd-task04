                            ...
                            <form action="controller" method="post">
                                ...
                                <div class="w3-container">
                                    <p>
                                        ...
                                        <input class="input-padding w3-input w3-round" type="text" name="name" value="${fn:escapeXml(sessionScope.genre.name)}" required maxlength="45">
                                    </p>
                                </div>
